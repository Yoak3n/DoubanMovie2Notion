...
def get_config(isbulk=None):
    ...
    if os.path.exists('./clc/keys/user_key.json'):
        with open('./clc/keys/user_key.json', 'r', encoding='utf-8') as fp:
        ...
        with open('./clc/keys/user_key.json', 'w', encoding='utf-8') as fp:
        ...
        if fromexternal:
            ...
            p = {
                "properties": {
                    ...
                    "Year": {"number": movie.year},"imdb": {"rich_text": [{"type": "text", "text": {"content": movie.imdb}}]},
                    "Duraiton": {"number": movie.duration},
                    "Rank": {"number": movie.rank_no}
                },
                "parent": {
